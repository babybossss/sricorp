...
insert into sri_os.txn_types (
  ...
  ('inv.sell_re', 'invest_sell', 'ขายอสังหาริมทรัพย์', 'Dispose real estate', 'investing'::sri_os.cf_group, 1, '1100', '1500', true, 'กำไรจากการขายทรัพย์ / ค่าใช้จ่ายอื่น', true, false, false, true, false, 'ตัดทรัพย์ออกตามต้นทุน รับเงินเข้าบัญชี และรับรู้กำไร/ขาดทุนจากการขายใน P&L', 'กำไรยังไม่รับรู้ (unrealized) ของทรัพย์ชิ้นนี้ต้องถูกล้างออกพร้อมกัน (Backlog ข้อ 4)', 400),
  ('inv.srr_redeem', 'invest_sell', 'รับไถ่ถอนขายฝาก (เงินต้น)', 'Redemption received', 'investing'::sri_os.cf_group, 1, '1100', '1400', true, 'ดอกเบี้ยรับ - ขายฝาก', true, true, false, false, true, 'เงินเข้าบัญชีเพิ่มขึ้น และเงินลงทุนขายฝากลดลง — ไม่ใช่รายได้', 'รับพร้อมดอกเบี้ยได้ในรายการเดียว แต่ต้องแยกยอดให้ชัด — เงินต้นลดลูกหนี้ ดอกเบี้ยเป็นรายได้', 401),
  ('inv.mortgage_redeem', 'invest_sell', 'รับไถ่ถอนจำนอง (เงินต้น)', 'Mortgage redeemed', 'investing'::sri_os.cf_group, 1, '1100', '1410', true, 'ดอกเบี้ยรับ - จำนอง', true, true, false, false, true, 'เงินเข้าบัญชีเพิ่มขึ้น และเงินลงทุนจำนองลดลง — ไม่ใช่รายได้', 'รับพร้อมดอกเบี้ยได้ในรายการเดียว แต่ต้องแยกยอดให้ชัด — เงินต้นลดลูกหนี้ ดอกเบี้ยเป็นรายได้', 402),
  ('inv.loan_back', 'invest_sell', 'รับคืนเงินให้กู้ยืม (เงินต้น)', 'Loan principal repaid', 'investing'::sri_os.cf_group, 1, '1100', '1300', true, 'ดอกเบี้ยรับ - เงินให้กู้ยืม', false, true, false, false, true, 'เงินเข้าบัญชีเพิ่มขึ้น และลูกหนี้เงินให้กู้ยืมลดลง — ไม่ใช่รายได้', 'รับพร้อมดอกเบี้ยได้ในรายการเดียว แต่ต้องแยกยอดให้ชัด — เงินต้นลดลูกหนี้ ดอกเบี้ยเป็นรายได้', 403),
  ('inv.sell_securities', 'invest_sell', 'ขายหลักทรัพย์ / กองทุน', 'Sell securities', 'investing'::sri_os.cf_group, 1, '1100', '1700', true, 'รายได้อื่น / ค่าใช้จ่ายอื่น', false, false, false, true, false, 'ตัดเงินลงทุนออกตามต้นทุน รับเงินเข้าบัญชี และรับรู้กำไร/ขาดทุนจากการขาย', null, 404),
  ...
  ('fin.repay_bank', 'finance_out', 'ชำระคืนเงินกู้ธนาคาร (เงินต้น)', 'Bank loan principal repaid', 'financing'::sri_os.cf_group, -1, '2410', '1100', true, 'ดอกเบี้ยจ่าย', false, true, false, false, true, 'เงินออกจากบัญชี และหนี้สินเงินกู้ธนาคารลดลง — เงินต้นไม่ใช่ค่าใช้จ่าย', 'เงินต้นไม่ใช่ค่าใช้จ่าย ต้องแยกออกจากดอกเบี้ยเสมอ (Backlog ข้อ 5)', 600),
  ('fin.repay_director', 'finance_out', 'ชำระคืนเงินกู้ยืมกรรมการ (เงินต้น)', 'Director loan repaid', 'financing'::sri_os.cf_group, -1, '2300', '1100', true, 'ดอกเบี้ยจ่าย', false, true, false, false, true, 'เงินออกจากบัญชี และหนี้สินเงินกู้ยืมกรรมการลดลง — ไม่ใช่ค่าใช้จ่าย', 'เงินต้นไม่ใช่ค่าใช้จ่าย ต้องแยกออกจากดอกเบี้ยเสมอ (Backlog ข้อ 5)', 601),
